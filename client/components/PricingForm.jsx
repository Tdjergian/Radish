...
const PricingForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!region || !serverType || !operatingSystem || !shardsValue || !replicasValue || !sentinelsValue) {
    ...
    try {
      ...
      console.log('Sending request data:', requestData); // Add this log to debug the request payload
